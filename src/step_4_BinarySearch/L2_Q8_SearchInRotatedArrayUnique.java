...
public class L2_Q8_SearchInRotatedArrayUnique {
    public static void main(String[] args) {
        ...
        int index = targetIdxInRotatedArrayUnique(array_list, target);
        System.out.println("Target : " + target + " found at : " + index + " in an array : " + array_list);

        scanner.close();
    }

    public static int targetIdxInRotatedArrayUnique(List<Integer> array_list , int target){
        int s = 0;
